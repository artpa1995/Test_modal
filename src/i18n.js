...
const messages = {
    en: {
        ...
        service_page:"Contextual advertising for you and Web site development",
        ...
        service_content_text:"Website development according to the presented design and the client's wishes, adding and changing functionality in a short time, website promotion, contextual advertising connection",
    ...
    ru: {
        ...
        service_page:"Контекстная реклама для Вас и Веб разработка сайтов",
        ...
        service_content_text:"Разработка сайта согласно представленному дизайну и пожеланиям клиента, добавление и изменение функционалов за короткий срок, продвижение сайта, подключение контекстной рекламы",
        ...
        home_service_content_heads: { title: 'Наши услуги', description: 'Мы создаем и продвигаем сайты разных типов, занимаемся их последующим суппортом'},
        service_content_bloks: [
    ...
    arm: {
        ...
        service_page:"Համատեքստային գովազդ ձեզ համար և վեբ կայքի մշակում",
        ...
        service_content_text:"Կայքի պատրաստում ըստ ներկայացված դիզայնի և հաճախորդի ցանկության, կարճ ժամանակում ֆունկցիոնալության ավելացում և փոփոխություն, կայքի առաջխաղացում, կոնտեքստային գովազդային կապ",
        ...
        home_service_content_heads: { title: 'Մեր ծառայությունները', description: 'Մենք ստեղծում և գովազդում ենք տարբեր տեսակի կայքեր, մենք զբաղվում ենք դրանց հետագա աջակցությամբ'},
        service_content_bloks: [
